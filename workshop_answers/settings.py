...
SESSION_CONFIGS = [
    ...
    {
        'name': 'lesson_two',
        'display_name': "Public good tutorial",
    ...
    },
    {
        ...
        'app_sequence': ['vote'],
        'treatment': "blue"
        # the treatment can be blue or red
    },
    {
        'name': 'minimum',
...
SECRET_KEY = '(9)8er@@*aybze29u*mddr_ru=+)h+2l3^lmsgy3z2q^q83@ze'

# if an app is included in SESSION_CONFIGS, you don't need to list it here
INSTALLED_APPS = ['otree', 'radiogrid']

EXTENSION_APPS = ['minimum', 'chat', 'stroop']