...
class Player(BasePlayer):
    task_body1 = models.IntegerField()  # here the body of yet unsolved task is stored
    task_body2 = models.IntegerField()
    ...
    def create_task(self):
        self.task_body1 = random.randint(11, 89)
        self.task_body2 = random.randint(11, 89)
        self.last_correct_answer = self.task_body1 + self.task_body2
